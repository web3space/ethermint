...
import (
	...
	"web3space/ethermint/components/tendermint/tendermint/libs/cmap"
	tmmath "web3space/ethermint/components/tendermint/tendermint/libs/math"
	"web3space/ethermint/components/tendermint/tendermint/libs/rand"
	tmrand "web3space/ethermint/components/tendermint/tendermint/libs/rand"
	...
	"web3space/ethermint/components/tendermint/tendermint/p2p/conn"
)
...
func (r *Reactor) dialPeer(addr *p2p.NetAddress) error {
	...
	if !r.Switch.IsPeerPersistent(addr) && attempts > maxAttemptsToDial {
		...
		// https://web3space/ethermint/components/tendermint/tendermint/issues/3572
		r.book.MarkBad(addr)
