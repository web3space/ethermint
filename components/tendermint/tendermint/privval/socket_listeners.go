...
import (
	...
	p2pconn "web3space/ethermint/components/tendermint/tendermint/p2p/conn"
)
...
func (ln *unixListener) Accept() (net.Conn, error) {
	...
	// with a MAC - https://web3space/ethermint/components/tendermint/tendermint/issues/3099
