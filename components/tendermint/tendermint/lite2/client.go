...
import (
	...
	"web3space/ethermint/components/tendermint/tendermint/lite2/provider"
	"web3space/ethermint/components/tendermint/tendermint/lite2/store"
...
// https://web3space/ethermint/components/tendermint/spec/blob/master/spec/consensus/light-client.md
//
// If the trusted header is more recent than one here, an error is returned.
