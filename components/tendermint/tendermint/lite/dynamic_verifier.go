...
import (
	...
	log "web3space/ethermint/components/tendermint/tendermint/libs/log"
	lerr "web3space/ethermint/components/tendermint/tendermint/lite/errors"
...
// see https://web3space/ethermint/components/tendermint/tendermint/issues/3170
...
func (dv *DynamicVerifier) Verify(shdr types.SignedHeader) error {
	...
	// See https://web3space/ethermint/components/tendermint/tendermint/issues/3174.
