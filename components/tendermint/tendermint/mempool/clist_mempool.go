...
import (
	...
	auto "web3space/ethermint/components/tendermint/tendermint/libs/autofile"
	"web3space/ethermint/components/tendermint/tendermint/libs/clist"
...
func (mem *CListMempool) Update(
	...
	for i, tx := range txs {
		...
		// Mempool after:
		//   100
		// https://web3space/ethermint/components/tendermint/tendermint/issues/3322.
		if e, ok := mem.txsMap.Load(txKey(tx)); ok {
