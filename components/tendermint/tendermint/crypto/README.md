...
`import "web3space/ethermint/components/tendermint/tendermint/crypto"`

For any specific algorithm, use its specific module e.g.
`import "web3space/ethermint/components/tendermint/tendermint/crypto/ed25519"`

If you want to decode bytes into one of the types, but don't care about the specific algorithm, use
`import "web3space/ethermint/components/tendermint/tendermint/crypto/amino"`

## Binary encoding

For Binary encoding, please refer to the [Tendermint encoding specification](https://web3space/ethermint/components/tendermint/tendermint/blob/master/docs/spec/blockchain/encoding.md).
