...
import (
	...
	"web3space/ethermint/components/tendermint/tendermint/libs/fail"
	...
	cstypes "web3space/ethermint/components/tendermint/tendermint/consensus/types"
	tmevents "web3space/ethermint/components/tendermint/tendermint/libs/events"
...
func (cs *State) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://web3space/ethermint/components/tendermint/tendermint/issues/1281
		// }
	...
	if err != nil { // nolint:staticcheck
		...
		// https://web3space/ethermint/components/tendermint/tendermint/issues/3406
...
func (cs *State) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if err == ErrVoteHeightMismatch {
			...
			// 		(https://web3space/ethermint/components/tendermint/tendermint/issues/3839).
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://web3space/ethermint/components/tendermint/spec.
