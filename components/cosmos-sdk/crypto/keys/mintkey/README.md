...
```bash
go test -v --bench web3space/ethermint/components/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: web3space/ethermint/components/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	web3space/ethermint/components/cosmos-sdk/crypto/keys/mintkey	12.093s
```
