...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"web3space/ethermint/components/cosmos-sdk/types/errors.Wrap",
		"web3space/ethermint/components/cosmos-sdk/types/errors.Wrapf",
		"web3space/ethermint/components/cosmos-sdk/types/errors.WithType",
